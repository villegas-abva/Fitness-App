    ...
    return Padding(
      ...
      child: ListView.builder(
        ...
        itemBuilder: (context, muscleIndex) {
          if (day['day'] == 'Sabado' || day['day'] == 'Domingo') {
            // return Column(
            //   children: [
            //     AppLargeText(
            //         size: 22,
            ...
            //         color: Colors.white),
            //     AppLargeText(size: 22, text: 'hula', color: Colors.white),
            //   ],
            // );
            return Column(
              ...
              children: [
                Center(
                  child: Lottie.asset('assets/lottie_animations/baby.json',
                ...
                Container(
                  ...
                  child: Center(
                    child: AppRegularText(
                        size: 22, text: 'Dia de Descanso', color: Colors.black),
                  ),
                ),
              ],
            );
